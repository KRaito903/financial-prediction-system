...
- predict (query): trả về time dự đoán (7, 14, 28) với timxer (tính theo ngày), tất các các khoảng thì sài timeGPT (theo ngay và gi điều được) => này cho khách hàng thường.
